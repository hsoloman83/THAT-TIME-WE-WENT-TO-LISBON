...
$(function(){
	...
	$(document).one('click', '.share-review', function(e) {
		$(this).html('<i class="fa fa-share-alt" aria-hidden="true"></i> You shared this');
		$(this).children('.fa-share-alt').addClass('animate-share');
	});
});
